...
<div class="f_dt">
    ...
    <div class="b_dt_1">
        <h2 style="margin-bottom:20px;">Thông Tin Liên Hệ</h2>
        <ul>
            <li class="clearfix">
                <span class="l1_bdt">
                    Người liên hệ
                    ...
                    <div class="sty_bdt"> 
                      <select name="loai" id="loai"  required="required"  > 
                            ...
                            while($row=mysql_fetch_assoc($cate)){
                                if($parent!=-1 && $parent!="" && $row['id'] == $parent){
                                    $selected = 'selected';
                                }
                            ?>
    ...
    <div class="b_dt_1">
        <h2 style="margin-bottom:20px;">Thông Tin BDS</h2>
        <ul>
          <li class="clearfix">
              <span class="l1_bdt">
    ...
    <div class="b_dt_2" style="padding:0px;">
         ...
         <textarea id="noidung" name="noidung" rows="16" cols="80" style="width:100%;"  required="required"> <?php echo $detail; ?></textarea> 
