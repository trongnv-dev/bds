	...
	if ($errMsg==''){
		...
		if (mysql_query($sql,$conn)){
			...
			if ($_FILES['file']['name']!=''){
				...
				$path_up_file="$path/bando_files/phuong_xa/$oldid$extlarge";
				if (makeUpload($_FILES['file'],$path_up_file)){
					@chmod("$path/bando_files/phuong_xa/$oldid$extlarge", 0777);
					if($sqlUpdateField != "") $sqlUpdateField .= ",";
					$sqlUpdateField .= " file='images/bando_files/phuong_xa/$oldid$extlarge' ";
				}
			}
