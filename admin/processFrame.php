...
switch ($frame){
	...
	case "thamdinh"               : include("thamdinh.php");break;	
	case "kygui"               : include("kygui.php");break;	
	case "chitietthamdinh"               : include("thamdinh_chitiet.php");break;	
	case "bando"          : include("bando/bando.php");break;
