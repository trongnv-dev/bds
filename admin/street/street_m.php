	...
	if ($errMsg==''){
		...
		if (mysql_query($sql,$conn)){
			...
			if ($_FILES['file']['name']!=''){
				...
				$path_up_file="$path/bando_files/duong_duan/$oldid$extlarge";
				if (makeUpload($_FILES['file'],$path_up_file)){
					@chmod("$path/bando_files/duong_duan/$oldid$extlarge", 0777);
					if($sqlUpdateField != "") $sqlUpdateField .= ",";
					$sqlUpdateField .= " file='images/bando_files/duong_duan/$oldid$extlarge' ";
				}
			}
                   ...
                   <form method="post" name="frmForm" enctype="multipart/form-data" action="admin.php?act=street_m">
                        ...
                        <input type="hidden" name="page" value="<?=$_REQUEST['page']?>">
                            ...
                            <table  class="table_chinh">
                                ...
                                <tr>
                                  <td class="table_chu_tieude_them" colspan="2" align="center" valign="middle"  >ĐƯỜNG / DỰ ÁN</td>
                              </tr>
                                <tr>
