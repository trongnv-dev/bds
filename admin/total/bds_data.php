...
<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
                           ...
                           $sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify,DATE_FORMAT(date_actived,'%d/%m/%Y %h:%i') as dateActive from tbl_rv_item where  $where $sortby  limit ".($startRow).",".$pageSize;
