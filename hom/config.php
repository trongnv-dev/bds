...
$root="http://bdstphcm.org/";
$sub="http://bdstphcm.org";
...
if($a==$sub){
	ini_set('session.cookie_domain', '.hocmarketingbinhduong.com');
	session_set_cookie_params (0, '/','.hocmarketingbinhduong.com'); 
