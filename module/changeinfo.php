<?php
		...
		$row_quantri=getRecord('tbl_users','id='.$id);
	...
	if (isset($_POST['btn_dangky'])==true)//isset kiem tra submit
	
		{
			...
			if($email!=NULL){
				if (check_table('tbl_users','email='."'".$email."' AND id!=".$id,'id')==false) {$coloi=true;echo  $coloi_hien_email = "Địa chỉ mail này đã có người dùng";}
			}
			if($mobile!=NULL){
				if (check_table('tbl_users','mobile='."'".$mobile."' AND id!=".$id,'id')==false) {$coloi=true; echo $coloi_hien_mobile = "Điện thoại này đã có người dùng";}
			}
    ...
    <article class="content">
        ...
        <div class="f_khung_dn2">
            ...
            <div class="t_khung_dn2">
               Thay đổi thông tin tài khoản <span style="color: #40B01A;">BDSTPHCM</span>
            </div><!-- End .t_khung_dn2 -->
             ...
             <form id="form1" name="form1" method="post" action="<?php echo $linkrootbds;?>sua-thong-tin.html">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="r_k_dn2">
                            <input name="btn_dangky" class="btn_dn2" type="submit" value="Cập nhật">
                        </span><!-- End .r_k_dn2 -->
                    </li>
                </ul>
