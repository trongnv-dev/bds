<?php
		...
		elseif ($matkhaulay!=$md5_pass_old1){$coloi=true; $error_pass= 'Mật khẩu củ bạn nhập không đúng...!';}
		else{ // cập nhật pass
             ...
             <form id="form1" name="form1" method="post" action="<?php echo $linkrootbds;?>doi-mat-khau.html">
                <ul>
                    ...
                    <li>
                        ...
                        <span class="r_k_dn2">
                            <input name="btn_doipass"  class="btn_dn2" type="submit" value="Đổi mật khẩu">
                        </span><!-- End .r_k_dn2 -->
                    </li>
                </ul>
                <span class="erros_fu_dndk" <?php if($coloi!=true){?> style="display: none;" <?php }?>> <?=$coloi_hien_tendk.$coloi_hien_matkhau.$coloi_hien_golaimatkhau.$coloi_hien_hoten.$coloi_hien_email.$coloi_hien_cap.$error_pass;?></span>
             </form>
            </div><!-- End .m_khung_dn2 -->
