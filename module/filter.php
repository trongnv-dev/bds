    ...
    <script>
        $(document).ready(function () {
            ...
            $("#tinh-index").change(function () {
                ...
                $("#huyen-index").load("<?php echo $linkrootbds?>module/getChildSubject.php?table=" + table + "&tablep=" + tablep + "&id=" + id); //alert(idthanhpho)
            });
            $("#huyen-index").change(function () {
                var id = $(this).val();//val(1) gan vao gia tri 1 dung trong form
                var table = "tbl_street";
                var tablep = "tbl_quanhuyen";
                $("#duong-index").load("<?php echo $linkrootbds?>module/getChildSubject.php?table=" + table + "&tablep=" + tablep + "&id=" + id); //alert(idthanhpho)
            });
            $("#loai-index").change(function () {
                var id = $(this).val();//val(1) gan vao gia tri 1 dung trong form
                var table = "tbl_rv_category";
                var tablep = "tbl_rv_category";
                $("#ddCat-index").load("<?php echo $linkrootbds?>module/getChildSubject.php?table=" + table + "&tablep=" + tablep + "&id=" + id); //alert(idthanhpho)
            });
        });
    </script>
    <h4 class="t_bs t_bs1">
    ...
    <div class="m_bs">
        <form action="<?php echo $linkrootbds; ?>tim-bds.html" method="POST" enctype="multipart/form-data">
            <div class="search_bs">
                ...
                <ul>
                    <li>
                        <select name="tinh" id="tinh-index" class="styled">
                    ...
                    <li>
                        <select name="huyen" id="huyen-index" class="styled">
                            <option value=""> Chọn Quận / Huyện</option>
                        </select>
                    </li>
                    <li>
                        <select name="phuong" id="phuong-index" class="styled">
                            <option value="">Chọn Phường / Xã</option>
                        </select>
                    </li>
                    <li>
                        <select name="loai" id="loai-index" class="styled">
                    ...
                    <li>
                        <select name="ddCat" id="ddCat-index" class="styled">
                            <option value="">Chọn hình thức</option>
                        </select>
                    </li>
                    <li class="check_3_search clearfix">
                        <div class="c1_s">
                            <select name="price-index" class="styled">
                        ...
                        <div class="c1_s">
                            <select name="dientich" id="dientich-index" class="styled" style="width:154px;">
