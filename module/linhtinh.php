...
<div class="f_cont clearfix">
    ...
    <article class="content">
        ...
        <div class="page">
                <div class="PageNum">
                    <?php  
					if($dem_para<8) echo pagesLinks_new_full($totalRows, $pageSize ,"http://www.bdstphcm.org/","p","page-nha-dat".$chuoi);
					else echo pagesLinks_new_full_2014($totalRows, $pageSize ,"http://www.bdstphcm.org/","page-nha-dat".$chuoi);
                    ?>
                </div>
                <div class="clear"></div>
            </div>
