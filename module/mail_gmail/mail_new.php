<?php 
	...
	$noidung_AltBody='
	Chào bạn! <br>
	Email này là do khách hàng của bạn gửi liên hệ thông qua website <a href="http://www.bdstphcm.org"> http://www.bdstphcm.org</a>  <br />';
...
if (isset($_POST['them'])==true)//isset kiem tra submit
	...
	/*	if ($cap!=NULL){
		...
		if($coloi==FALSE)
		{
			...
			.'<br> <br><hr>
			SCODEWEB chúc bạn thực hiện giao dịch thành công, chúc công việc kinh doanh của bạn ngày càng thuận lợi. <br>';
		
			
			$ng_ten=$tennguoigui_name;
			
			$ng_email=$row_guimail['cauhinh_mail_ten'];
			...
			$kq=@guimail($ng_ten,$ng_email,$ch_email,$ch_pass,$tennguoigui_name,$nguoigui_from,$tieude,$noidung);
