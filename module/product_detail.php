...
<div class="page-head">
    <div class="container">
        ...
        <span typeof="v:Breadcrumb">
            <a style="color: #fff;" rel="v:url" property="v:title" href="<?php echo $linkrootbds ?>" title="Trang chủ"> Trang chủ </a>
        </span>
                            <?php if ($ghinho == 1) { ?>
                                <?php if ($row_sanpham['cate'] == 0) { ?>
                                    <span typeof="v:Breadcrumb"> &raquo;
               <a rel="v:url" property="v:title"
                  href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'subject'); ?>.html">  <?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'name'); ?>  </a>
            </span>
                                    <span typeof="v:Breadcrumb"> &raquo;
               <a rel="v:url" property="v:title"
                  href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'subject'); ?>/<?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'subject'); ?>.html"
                  title="<?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'name'); ?>"> <?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'name'); ?>  </a>
            </span>
                                    <span typeof="v:Breadcrumb"> &raquo;
               <a rel="v:url" property="v:title"
                  href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'subject'); ?>/<?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'subject'); ?>/<?= get_field('tbl_phuongxa', 'id', $row_sanpham['idphuong'], 'subject'); ?>.html"
                  title="<?= get_field('tbl_phuongxa', 'id', $row_sanpham['idphuong'], 'name'); ?>"> <?= get_field('tbl_phuongxa', 'id', $row_sanpham['idphuong'], 'name'); ?> </a>
            </span>
                                    <span typeof="v:Breadcrumb">  &raquo;
                <a rel="v:url" property="v:title"
                   href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'subject'); ?>/<?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'subject'); ?>/<?= get_field('tbl_phuongxa', 'id', $row_sanpham['idphuong'], 'subject'); ?>/<?= $catebds1 ?>.html"
                   title=" <? echo get_field('tbl_rv_category', 'id', get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'parent'), 'name'); ?> ">  <? echo get_field('tbl_rv_category', 'id', get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'parent'), 'name'); ?>  </a>
             </span>
                                    <span typeof="v:Breadcrumb">&raquo;
                 <a rel="v:url" property="v:title"
                    href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $row_sanpham['idcity'], 'subject'); ?>/<?= get_field('tbl_quanhuyen', 'id', $row_sanpham['idquan'], 'subject'); ?>/<?= get_field('tbl_phuongxa', 'id', $row_sanpham['idphuong'], 'subject'); ?>/<?= $catebds1 ?>/<?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'subject'); ?>.html"
                    title="<?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?>"> <?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?>  </a>
              </span>
                 	...
                 	<?= $row_sanpham['name'] ?>
                                ...
                                <?php } else { ?>
                                    ...
                                    if ($row_sanpham['cate'] == 1) {
                                        ...
                                        <span typeof="v:Breadcrumb"> &raquo;
                   <a rel="v:url" property="v:title"
                      href="<?php echo $linkrootbds ?><?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'subject'); ?>.html"
                      title="<?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?>"> <?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?> </a>
                </span>
                   ...
                   <a rel="v:url" property="v:title"
                      ...
                      title="<?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?>"> <?= get_field('tbl_rv_category', 'id', $row_sanpham['parent'], 'name'); ?> </a>
                                    ...
                                    <? } elseif ($row_sanpham['cate'] == 5) { ?>
                                        <span typeof="v:Breadcrumb"> &raquo;
                	<a rel="v:url" property="v:title" href="<?php echo $linkrootbds ?>nha-dat-chua-xac-thuc.html"
                       title="<Nhà đất chưa xác thực">Nhà đất chưa xác thực</a>
                </span>
                                    <? } ?>
                                    <span typeof="v:Breadcrumb">&raquo;
				 <?= $row_sanpham['name']; ?>
				 ...
				 <?= get_field('tbl_quanhuyen_category', 'subject', $bds, 'name'); ?>
                            ...
                            <?php } elseif ($ghinho == 4) { ?>
                                <span typeof="v:Breadcrumb"> &raquo;
            	  <a title="<?= get_field('tbl_quanhuyen_category', 'id', $tp, 'name'); ?>" rel="v:url"
                     property="v:title"
                     href="<?php echo $linkrootbds ?><?= get_field('tbl_quanhuyen_category', 'id', $tp, 'subject'); ?>.html">   <?= get_field('tbl_quanhuyen_category', 'id', $tp, 'name'); ?> </a>
           </span>
                                <span typeof="v:Breadcrumb">&raquo;
                   <?= $duong['name'] ?>
            </span>
