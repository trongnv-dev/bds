var scrolltotop={
	...
	controlHTML: '<img src="/templates/images/up.png" style="width:25px; height:25px; position:relative; z-index:999;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
